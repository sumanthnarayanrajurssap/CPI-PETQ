...
if not exist "%1\Archive" mkdir %1\Archive
move %USERPROFILE%\supaData\%latestDir% %USERPROFILE%\supaData\latestResult
ECHO the latest folder path = %USERPROFILE%\supaData\%latestDir% renamed to %USERPROFILE%\supaData\latestResult
move %1\latestResult %1\latestResult_%2
move %1\latestResult_%2 %1\Archive\
ECHO final folder directory = %1\latestResult_%2
